...
namespace Do_an_OOP
{
    public class Database
    {
        ...
        public Database()
        {
            ...
            data.Add(new Experience("01", "Nguyễn Văn A", new DateTime(2002, 5, 18), "0973115481", "anguyen@gmail.com", 0, 5, "C#"));
            data.Add(new Experience("02", "Trần Văn B", new DateTime(2002, 4, 20), "0922300178", "btran@gmail.com", 0, 3, "C#"));
            data.Add(new Intern("03", "Đặng Văn C", new DateTime(2002, 9, 15), "0902115679", "cdang@gmail.com", 1, "IT", 4, "UEH"));
            data.Add(new Fresher("04", "Đỗ Thị D", new DateTime(2002, 10, 3), "0913445278", "ddo@gmail.com", 2, new DateTime(2022, 5, 23), 3, "UEH"));
